...
export default function HomePage() {
  return (
    <>
      <div className="relative min-h-screen overflow-hidden flex font-lato">
        <video
          autoPlay
          loop
          muted
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start justify-start min-h-screen w-full px-4 md:px-8">
          ...
          <div
            className="relative flex items-center justify-center md:ml-20 mt-10 md:mt-48 
      ...
      <div className="flex flex-col md:flex-row bg-black min-h-[700px] md:h-[700px] justify-start items-center md:items-start px-4 md:px-24">
  ...
  <div className="flex flex-col w-full mt-12 md:mt-48 items-center md:items-start text-center md:text-left">
    
    <h1 className="text-white relative md:right-[290px] md:top-[-120px] font-semibold font-lato text-4xl sm:text-6xl md:text-8xl mb-6">
      About <br /> me
    </h1>

    
    <div className="w-full flex justify-center sm:justify-end mb-4 relative md:top-[-200px]">
      <FaArrowRight className="text-4xl sm:text-5xl md:text-7xl text-[#70117C] w-[120px] sm:w-[160px] md:w-[200px]" />
    </div>

    <div className="relative md:top-[-210px] flex w-full">
    ...
    <div className="relative md:bottom-[180px] flex flex-col sm:flex-row items-center sm:items-start gap-6 mt-8">
      <button className="bg-gradient-to-r from-[#3a0060] to-[#6C169D] text-white px-5 py-2 rounded font-bold hover:opacity-90 transition w-full sm:w-auto">
        Contact Me
      </button>

      <div className="opacity-60 mt-4 sm:mt-0">
